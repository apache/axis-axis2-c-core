        ...
        axis2_hash_t *methods)
{
    ...
    msg_ref_element->ops->set_msg_label = 
            axis2_hash_get(methods, "set_msg_label", 
            AXIS2_HASH_KEY_STRING);

    msg_ref_element->ops->get_msg_label = 
            axis2_hash_get(methods, "get_msg_label", 
            AXIS2_HASH_KEY_STRING);
 
    msg_ref_element->ops->set_msg_content_model = 
            axis2_hash_get(methods, "set_msg_content_model", 
            AXIS2_HASH_KEY_STRING);

    msg_ref_element->ops->get_msg_content_model = 
            axis2_hash_get(methods, "get_msg_cotent_model", 
            AXIS2_HASH_KEY_STRING);
 
    msg_ref_element->ops->set_element_qname = 
            axis2_hash_get(methods, "set_element_qname", 
            AXIS2_HASH_KEY_STRING);

    msg_ref_element->ops->get_element_qname = 
            axis2_hash_get(methods, "get_element_qname", 
            AXIS2_HASH_KEY_STRING);


    msg_ref_element->ops->get_element = 
            axis2_hash_get(methods, "get_element", 
            AXIS2_HASH_KEY_STRING);

   
    msg_ref_element->ops->set_direction = 
            axis2_hash_get(methods, "set_direction", 
            AXIS2_HASH_KEY_STRING);

    msg_ref_element->ops->get_direction = 
