...
typedef struct axis2_woden_type_def_impl axis2_woden_type_def_impl_t;
...
#define INTF_TO_IMPL(type_def) ((axis2_woden_type_def_impl_t *) type_def)

axis2_status_t AXIS2_CALL 
axis2_woden_type_def_free(
        void *type_def,
        const axis2_env_t *env);

axis2_hash_t *AXIS2_CALL 
axis2_woden_type_def_super_objs(
        void *type_def,
        const axis2_env_t *env);

axis2_woden_obj_types_t AXIS2_CALL
axis2_woden_type_def_type(
        void *type_def,
        const axis2_env_t *env);

axis2_status_t AXIS2_CALL 
axis2_woden_type_def_set_qname(
        void *type_def,
        const axis2_env_t *env,
        axis2_qname_t *qname);

axis2_qname_t *AXIS2_CALL 
axis2_woden_type_def_get_qname(
        void *type_def,
        const axis2_env_t *env);
...
axis2_status_t AXIS2_CALL 
axis2_woden_type_def_set_content_model(
        void *type_def,
        const axis2_env_t *env,
        axis2_char_t *content_model);

axis2_char_t *AXIS2_CALL 
axis2_woden_type_def_get_content_model(
        void *type_def,
        const axis2_env_t *env);


axis2_status_t AXIS2_CALL
axis2_woden_type_def_set_content(
        void *type_def,
        const axis2_env_t *env,
        void *type_def_content);

void *AXIS2_CALL
axis2_woden_type_def_get_content(
        void *type_def,
        const axis2_env_t *env);

static axis2_woden_type_def_t *
...
create(const axis2_env_t *env)
{
    ...
    type_def_impl = AXIS2_MALLOC(env->allocator, 
                    sizeof(axis2_woden_type_def_impl_t));

    type_def_impl->super = NULL;
    type_def_impl->methods = NULL;
    type_def_impl->obj_type = AXIS2_WODEN_TYPE_DEF;
    ...
    type_def_impl->type_def.ops = AXIS2_MALLOC(env->allocator, 
                    sizeof(axis2_woden_type_def_ops_t));

    type_def_impl->type_def.ops->free = axis2_woden_type_def_free;
    type_def_impl->type_def.ops->super_objs = 
        axis2_woden_type_def_super_objs;
    type_def_impl->type_def.ops->type = axis2_woden_type_def_type;
    ...
    axis2_hash_set(type_def_impl->methods, "set_qname", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_set_qname);
    axis2_hash_set(type_def_impl->methods, "get_qname", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_get_qname);
    axis2_hash_set(type_def_impl->methods, "set_system", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_set_system);
    axis2_hash_set(type_def_impl->methods, "get_system", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_get_system);
    axis2_hash_set(type_def_impl->methods, "set_content_model", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_set_content_model);
    axis2_hash_set(type_def_impl->methods, "get_content_model", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_get_content_model);
    axis2_hash_set(type_def_impl->methods, "set_content", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_set_content);
    axis2_hash_set(type_def_impl->methods, "get_content", 
            AXIS2_HASH_KEY_STRING, axis2_woden_type_def_get_content);
        ...
        const axis2_env_t *env)
{
    ...
    AXIS2_ENV_CHECK(env, AXIS2_FAILURE);
    type_def_impl = (axis2_woden_type_def_impl_t *) create(env);
    ...
    axis2_hash_set(type_def_impl->super, "AXIS2_WODEN_TYPE_DEF", 
...
axis2_woden_obj_types_t AXIS2_CALL
axis2_woden_type_def_type(void *type_def,
        const axis2_env_t *env)
{
    axis2_woden_type_def_impl_t *type_def_impl = NULL;
...
axis2_woden_type_def_resolve_methods(
        ...
        axis2_hash_t *methods)
{
    axis2_woden_type_def_impl_t *type_def_impl_l = NULL;
        ...
        axis2_qname_t *qname)
{
    ...
    super = AXIS2_WODEN_TYPE_DEF_SUPER_OBJS(type_def, env);
    type_def_impl = INTF_TO_IMPL(axis2_hash_get(super, 
                "AXIS2_WODEN_TYPE_DEF", AXIS2_HASH_KEY_STRING));
