...
typedef struct axis2_woden_soap_binding_fault_exts_impl axis2_woden_soap_binding_fault_exts_impl_t;
...
#define INTF_TO_IMPL(binding_fault_exts) ((axis2_woden_soap_binding_fault_exts_impl_t *) binding_fault_exts)
        ...
        const axis2_env_t *env)
{
    ...
    {
        binding_fault_exts_impl = (axis2_woden_soap_binding_fault_exts_impl_t *) create(env);
    }
    else
        binding_fault_exts_impl = (axis2_woden_soap_binding_fault_exts_impl_t *) binding_fault_exts;
...
create(const axis2_env_t *env)
{
    ...
    axis2_hash_set(binding_fault_exts_impl->methods, "super_objs", 
            AXIS2_HASH_KEY_STRING, axis2_woden_soap_binding_fault_exts_super_objs);
    axis2_hash_set(binding_fault_exts_impl->methods, "type", 
            AXIS2_HASH_KEY_STRING, axis2_woden_soap_binding_fault_exts_type);
...
axis2_woden_soap_binding_fault_exts_create(const axis2_env_t *env)
{
    ...
    binding_fault_exts_impl->component_exts = axis2_woden_component_exts_create(env);
    ...
    axis2_hash_set(binding_fault_exts_impl->super, "AXIS2_WODEN_COMPONENT_EXTS", AXIS2_HASH_KEY_STRING, 
                        ...
                        const axis2_env_t *env)
{
    ...
    {
        AXIS2_WODEN_COMPONENT_EXTS_FREE(binding_fault_exts_impl->component_exts, env);
        binding_fault_exts_impl->component_exts = NULL;
    }
        ...
        const axis2_env_t *env) 
{
    ...
    code = (axis2_woden_qname_or_token_any_attr_t *) 
        AXIS2_WODEN_ATTR_EXTENSIBLE_GET_EXT_ATTR(parent_element, env, binding_fault_exts_impl->qname); 
    if(NULL == code)
    {
        ...
        const axis2_env_t *env) 
{
    ...
    subcodes = (axis2_woden_qname_list_or_token_any_attr_t *) 
        AXIS2_WODEN_ATTR_EXTENSIBLE_GET_EXT_ATTR(parent_element, env, binding_fault_exts_impl->qname); 
    if(NULL == subcodes)
    {
        /* defaults to xs:token #any if the attribute is omitted from the WSDL.*/
