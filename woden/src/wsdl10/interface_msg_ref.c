...
axis2_status_t AXIS2_CALL
woden_interface_msg_ref_set_qname(
        void *interface_msg_ref,
        const axis2_env_t *env,
        axis2_qname_t *qname);

axis2_qname_t *AXIS2_CALL
woden_interface_msg_ref_get_qname(
        void *interface_msg_ref,
        const axis2_env_t *env);

axis2_status_t AXIS2_CALL
woden_interface_msg_ref_set_msg(
        void *interface_msg_ref,
        const axis2_env_t *env,
        void *msg);

void *AXIS2_CALL
woden_interface_msg_ref_get_msg(
        void *interface_msg_ref,
        const axis2_env_t *env);

axis2_status_t AXIS2_CALL
woden_interface_msg_ref_set_msg_qname(
        void *interface_msg_ref,
        const axis2_env_t *env,
        axis2_qname_t *element);

axis2_qname_t *AXIS2_CALL
woden_interface_msg_ref_get_msg_qname(
        void *interface_msg_ref,
        const axis2_env_t *env);
        ...
        const axis2_env_t *env)
{
    ...
    msg_ref = WODEN_INTERFACE_MSG_REF_ELEMENT_GET_MSG(interface_msg_ref, 
            env);
    msg_ref = woden_msg_ref_to_msg_ref_element(msg_ref, env);
    return WODEN_MSG_REF_ELEMENT_GET_MSG_CONTENT_MODEL(msg_ref, env);
        ...
        const axis2_env_t *env)
{
    ...
    msg_ref = WODEN_INTERFACE_MSG_REF_ELEMENT_GET_MSG(interface_msg_ref, 
            env);
    msg_ref = woden_msg_ref_to_msg_ref_element(msg_ref, env);
    part = WODEN_MSG_REF_ELEMENT_GET_PART(msg_ref, env);
    return WODEN_PART_GET_ELEMENT_DECLARATION(part, env);
        ...
        axis2_qname_t *element)
{
    ...
    return WODEN_PART_ELEMENT_SET_ELEMENT_QNAME(part, env, element);
        ...
        const axis2_env_t *env)
{
    ...
    part = WODEN_MSG_REF_ELEMENT_GET_PART(msg_ref, env);
    part = woden_part_to_part_element(part, env);
    return WODEN_PART_ELEMENT_GET_ELEMENT_QNAME(part, env);
}
        ...
        void *element)
{
    ...
    msg_ref = woden_msg_ref_to_msg_ref_element(msg_ref, env);
    part = WODEN_MSG_REF_ELEMENT_GET_PART(msg_ref, env);
    return WODEN_PART_SET_ELEMENT_DECLARATION(part, env, element);
        ...
        void *types)
{
    ...
    msg_ref = woden_msg_ref_to_msg_ref_element(msg_ref, env);
    part = WODEN_MSG_REF_ELEMENT_GET_PART(msg_ref, env);
    return WODEN_PART_SET_TYPES(part, env, types);
