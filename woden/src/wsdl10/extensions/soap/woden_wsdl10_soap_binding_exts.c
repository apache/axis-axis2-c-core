...
typedef struct woden_wsdl10_soap_binding_exts_impl woden_wsdl10_soap_binding_exts_impl_t;

/**
 * @brief Soap Binding Extensions Struct Impl
 *   Axis2 Soap Binding Extensions
 */
struct woden_wsdl10_soap_binding_exts_impl
{
...
woden_wsdl10_soap_binding_exts_type(
    void *binding_exts,
    const axutil_env_t *env);

woden_component_exts_t *AXIS2_CALL
woden_wsdl10_soap_binding_exts_get_base_impl(
    void *binding_exts,
    const axutil_env_t *env);
...
static woden_wsdl10_soap_binding_exts_t *
create(const axutil_env_t *env);

static axis2_status_t
woden_wsdl10_soap_binding_exts_free_ops(
    void *binding_exts,
    const axutil_env_t *env);
    ...
    const axutil_env_t *env)
{
    ...
    if (!binding_exts)
    {
        binding_exts_impl = (woden_wsdl10_soap_binding_exts_impl_t *) create(env);
    }
    else
        binding_exts_impl = (woden_wsdl10_soap_binding_exts_impl_t *) binding_exts;
...
create(const axutil_env_t *env)
{
    ...
    binding_exts_impl = AXIS2_MALLOC(env->allocator,
            sizeof(woden_wsdl10_soap_binding_exts_impl_t));

    binding_exts_impl->obj_type = WODEN_WSDL10_SOAP_BINDING_EXTS;
    ...
    binding_exts_impl->binding_exts.ops = AXIS2_MALLOC(env->allocator,
            sizeof(woden_wsdl10_soap_binding_exts_ops_t));

    binding_exts_impl->binding_exts.ops->free = woden_wsdl10_soap_binding_exts_free;
...
AXIS2_EXTERN woden_wsdl10_soap_binding_exts_t * AXIS2_CALL
woden_wsdl10_soap_binding_exts_create(const axutil_env_t *env)
{
    woden_wsdl10_soap_binding_exts_impl_t *binding_exts_impl = NULL;
...
axis2_status_t AXIS2_CALL
woden_wsdl10_soap_binding_exts_free(void *binding_exts,
        const axutil_env_t *env)
{
    woden_wsdl10_soap_binding_exts_impl_t *binding_exts_impl = NULL;
