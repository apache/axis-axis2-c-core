...
typedef struct woden_wsdl10_soap_binding_fault_ref_exts_impl woden_wsdl10_soap_binding_fault_ref_exts_impl_t;

/**
 * @brief Soap Binding Fault Reference Extensions Struct Impl
 *   Axis2 Soap Binding Fault Reference Extensions
 */
struct woden_wsdl10_soap_binding_fault_ref_exts_impl
{
...
woden_wsdl10_soap_binding_fault_ref_exts_type(
    void *binding_fault_ref_exts,
    const axutil_env_t *env);

woden_component_exts_t *AXIS2_CALL
woden_wsdl10_soap_binding_fault_ref_exts_get_base_impl(
    void *binding_fault_ref_exts,
    const axutil_env_t *env);
...
static woden_wsdl10_soap_binding_fault_ref_exts_t *
create(
    const axutil_env_t *env);

static axis2_status_t
woden_wsdl10_soap_binding_fault_ref_exts_free_ops(
    void *binding_fault_ref_exts,
    const axutil_env_t *env);
    ...
    const axutil_env_t *env)
{
    ...
    {
        binding_fault_ref_exts_impl = (woden_wsdl10_soap_binding_fault_ref_exts_impl_t *) create(env);
    }
    else
        binding_fault_ref_exts_impl = (woden_wsdl10_soap_binding_fault_ref_exts_impl_t *) binding_fault_ref_exts;
...
create(const axutil_env_t *env)
{
    ...
    binding_fault_ref_exts_impl = AXIS2_MALLOC(env->allocator,
            sizeof(woden_wsdl10_soap_binding_fault_ref_exts_impl_t));

    binding_fault_ref_exts_impl->obj_type = WODEN_WSDL10_SOAP_BINDING_FAULT_REF_EXTS;
    ...
    binding_fault_ref_exts_impl->binding_fault_ref_exts.ops = AXIS2_MALLOC(env->allocator,
            sizeof(woden_wsdl10_soap_binding_fault_ref_exts_ops_t));

    binding_fault_ref_exts_impl->binding_fault_ref_exts.ops->free = woden_wsdl10_soap_binding_fault_ref_exts_free;
...
AXIS2_EXTERN woden_wsdl10_soap_binding_fault_ref_exts_t * AXIS2_CALL
woden_wsdl10_soap_binding_fault_ref_exts_create(const axutil_env_t *env)
{
    woden_wsdl10_soap_binding_fault_ref_exts_impl_t *binding_fault_ref_exts_impl = NULL;
...
axis2_status_t AXIS2_CALL
woden_wsdl10_soap_binding_fault_ref_exts_free(void *binding_fault_ref_exts,
        const axutil_env_t *env)
{
    woden_wsdl10_soap_binding_fault_ref_exts_impl_t *binding_fault_ref_exts_impl = NULL;
