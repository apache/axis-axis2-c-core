...
#ifndef AXIS2_WODEN_SOAP_BINDING_OP_EXTS_H
#define AXIS2_WODEN_SOAP_BINDING_OP_EXTS_H

/**
 * @file axis2_woden_soap_binding_op_exts.h
...
/** @defgroup axis2_woden_soap_binding_op_exts Soap Binding Operation Extensions
  * @ingroup axis2_wsdl
  * @{
  */

typedef union axis2_woden_soap_binding_op_exts_base axis2_woden_soap_binding_op_exts_base_t;
typedef struct axis2_woden_soap_binding_op_exts axis2_woden_soap_binding_op_exts_t;
typedef struct axis2_woden_soap_binding_op_exts_ops axis2_woden_soap_binding_op_exts_ops_t;
...
struct axis2_woden_soap_binding_op_exts
{
...
#endif
#endif /* AXIS2_WODEN_SOAP_BINDING_OP_EXTS_H */
