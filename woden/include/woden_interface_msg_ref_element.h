...
#define WODEN_INTERFACE_MSG_REF_ELEMENT_SET_QNAME(interface_msg_ref_element, env, qname) \
      (((woden_interface_msg_ref_element_t *) interface_msg_ref_element)->ops->\
        set_qname  (interface_msg_ref_element, env, qname))

#define WODEN_INTERFACE_MSG_REF_ELEMENT_GET_QNAME(interface_msg_ref_element, env) \
      (((woden_interface_msg_ref_element_t *) interface_msg_ref_element)->ops->\
        get_qname  (interface_msg_ref_element, env))

#define WODEN_INTERFACE_MSG_REF_ELEMENT_SET_MSG(interface_msg_ref_element, env, msg) \
      (((woden_interface_msg_ref_element_t *) interface_msg_ref_element)->ops->\
        set_msg  (interface_msg_ref_element, env, msg))

#define WODEN_INTERFACE_MSG_REF_ELEMENT_GET_MSG(interface_msg_ref_element, env) \
      (((woden_interface_msg_ref_element_t *) interface_msg_ref_element)->ops->\
        get_msg  (interface_msg_ref_element, env))

#define WODEN_INTERFACE_MSG_REF_ELEMENT_SET_MSG_QNAME(interface_msg_ref_element, env, element) \
      (((woden_interface_msg_ref_element_t *) interface_msg_ref_element)->ops->\
        set_msg_qname  (interface_msg_ref_element, env, element))

#define WODEN_INTERFACE_MSG_REF_ELEMENT_GET_MSG_QNAME(interface_msg_ref_element, env) \
      (((woden_interface_msg_ref_element_t *) interface_msg_ref_element)->ops->\
