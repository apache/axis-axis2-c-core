...
#ifndef WODEN_MSG_REF_ELEMENT_H
#define WODEN_MSG_REF_ELEMENT_H
...
#define WODEN_MSG_REF_ELEMENT_FREE(msg_ref_element, env) \
      (((woden_msg_ref_element_t *) msg_ref_element)->ops->\
         free (msg_ref_element, env))

#define WODEN_MSG_REF_ELEMENT_TYPE(msg_ref_element, env) \
      (((woden_msg_ref_element_t *) msg_ref_element)->ops->\
         type (msg_ref_element, env))

#define WODEN_MSG_REF_ELEMENT_SET_PART(msg_ref_element, env, part) \
      (((woden_msg_ref_element_t *) msg_ref_element)->ops->\
         set_part (msg_ref_element, env, part))

#define WODEN_MSG_REF_ELEMENT_GET_PART(msg_ref_element, env) \
      (((woden_msg_ref_element_t *) msg_ref_element)->ops->\
        get_part  (msg_ref_element, env))

#define WODEN_MSG_REF_ELEMENT_GET_MSG_CONTENT_MODEL(msg_ref_element, env) \
      (((woden_msg_ref_element_t *) msg_ref_element)->ops->\
        get_msg_content_model  (msg_ref_element, env))

#define WODEN_MSG_REF_ELEMENT_SET_QNAME(msg_ref_element, env, element) \
      (((woden_msg_ref_element_t *) msg_ref_element)->ops->\
        set_qname  (msg_ref_element, env, element))

#define WODEN_MSG_REF_ELEMENT_GET_QNAME(msg_ref_element, env) \
      (((woden_msg_ref_element_t *) msg_ref_element)->ops->\
