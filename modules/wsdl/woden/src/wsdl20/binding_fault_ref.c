...
typedef struct axis2_woden_binding_fault_ref_impl axis2_woden_binding_fault_ref_impl_t;
...
#define INTF_TO_IMPL(binding_fault_ref) ((axis2_woden_binding_fault_ref_impl_t *) binding_fault_ref)

axis2_status_t AXIS2_CALL 
axis2_woden_binding_fault_ref_free(
        void *binding_fault_ref,
        axis2_env_t **env);

axis2_hash_t *AXIS2_CALL 
axis2_woden_binding_fault_ref_super_objs(
        void *binding_fault_ref,
        axis2_env_t **env);

axis2_woden_obj_types_t AXIS2_CALL 
axis2_woden_binding_fault_ref_type(
        void *binding_fault_ref,
        axis2_env_t **env);

axis2_woden_nested_configurable_t *AXIS2_CALL
axis2_woden_binding_fault_ref_get_base_impl(
        void *binding_fault_ref,
        axis2_env_t **env);
 ...
 * ************************************************************/
void *AXIS2_CALL
axis2_woden_binding_fault_ref_get_interface_fault_ref(
        void *binding_fault_ref,
        axis2_env_t **env);

void *AXIS2_CALL
axis2_woden_binding_fault_ref_get_direction(
        void *binding_fault_ref,
        axis2_env_t **env);

void *AXIS2_CALL
axis2_woden_binding_fault_ref_to_element(
        void *binding_fault_ref,
        axis2_env_t **env);
 ...
 * ************************************************************/
axis2_status_t AXIS2_CALL
axis2_woden_binding_fault_ref_set_ref(
        void *binding_fault_ref,
        axis2_env_t **env,
        axis2_qname_t *fault_qname);

axis2_qname_t *AXIS2_CALL
axis2_woden_binding_fault_ref_get_ref(
        void *binding_fault_ref,
        axis2_env_t **env);

void *AXIS2_CALL
axis2_woden_binding_fault_ref_get_interface_fault_ref_element(
        void *binding_fault_ref,
        axis2_env_t **env);

axis2_status_t AXIS2_CALL
axis2_woden_binding_fault_ref_set_msg_label(
        void *binding_fault_ref,
        axis2_env_t **env,
        void *msg_label);

void *AXIS2_CALL
axis2_woden_binding_fault_ref_get_msg_label(
        void *binding_fault_ref,
        axis2_env_t **env);
...
axis2_status_t AXIS2_CALL
axis2_woden_binding_fault_ref_set_interface_fault_ref(
        void *binding_fault_ref,
        axis2_env_t **env,
        void *fault_ref);

static axis2_woden_binding_fault_ref_t *
        ...
        axis2_env_t **env)
{
    ...
    binding_fault_ref_impl->binding_fault_ref.base.binding_fault_ref_element.ops = 
        AXIS2_MALLOC((*env)->allocator, 
                sizeof(axis2_woden_binding_fault_ref_element_ops_t));
    axis2_woden_binding_fault_ref_element_resolve_methods(&(binding_fault_ref_impl->binding_fault_ref.base.
            binding_fault_ref_element), env, binding_fault_ref_impl->methods);
    return binding_fault_ref;
}

axis2_status_t AXIS2_CALL
axis2_woden_binding_fault_ref_to_binding_fault_ref_element_free(
        void *binding_fault_ref,
        axis2_env_t **env)
{
    axis2_woden_binding_fault_ref_impl_t *binding_fault_ref_impl = NULL;
        ...
        axis2_env_t **env)
{
    ...
    axis2_woden_nested_configurable_resolve_methods(&(binding_fault_ref_impl->binding_fault_ref.base.
...
axis2_status_t AXIS2_CALL
axis2_woden_binding_fault_ref_to_nested_configurable_free(
        void *binding_fault_ref,
        axis2_env_t **env)
{
    axis2_woden_binding_fault_ref_impl_t *binding_fault_ref_impl = NULL;
        ...
        axis2_env_t **env)
{
    ...
    axis2_woden_configurable_resolve_methods(&(binding_fault_ref_impl->binding_fault_ref.base.
            nested_configurable.base.configurable), env, configurable, binding_fault_ref_impl->methods);
    return binding_fault_ref;
}

axis2_status_t AXIS2_CALL
axis2_woden_binding_fault_ref_to_configurable_free(
        void *binding_fault_ref,
        axis2_env_t **env)
{
    axis2_woden_binding_fault_ref_impl_t *binding_fault_ref_impl = NULL;
    ...
    if(binding_fault_ref_impl->binding_fault_ref.base.nested_configurable.base.configurable.ops)
    {
        ...
        binding_fault_ref_impl->binding_fault_ref.base.nested_configurable.base.configurable.ops = NULL;
    }
    return AXIS2_SUCCESS;
}
...
create(axis2_env_t **env)
{
    ...
    binding_fault_ref_impl = AXIS2_MALLOC((*env)->allocator, 
                    sizeof(axis2_woden_binding_fault_ref_impl_t));

    binding_fault_ref_impl->obj_type= AXIS2_WODEN_BINDING_FAULT_REF;
    ...
    binding_fault_ref_impl->binding_fault_ref.ops->free = axis2_woden_binding_fault_ref_free;
    binding_fault_ref_impl->binding_fault_ref.ops->super_objs = axis2_woden_binding_fault_ref_super_objs;
    binding_fault_ref_impl->binding_fault_ref.ops->type = axis2_woden_binding_fault_ref_type;
    binding_fault_ref_impl->binding_fault_ref.ops->get_base_impl = axis2_woden_binding_fault_ref_get_base_impl;
    ...
    axis2_hash_set(binding_fault_ref_impl->methods, "free", AXIS2_HASH_KEY_STRING, 
            axis2_woden_binding_fault_ref_free);
    axis2_hash_set(binding_fault_ref_impl->methods, "to_binding_fault_ref_element_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_binding_fault_ref_to_binding_fault_ref_element_free);
    axis2_hash_set(binding_fault_ref_impl->methods, "to_nested_configurable_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_binding_fault_ref_to_nested_configurable_free);
    axis2_hash_set(binding_fault_ref_impl->methods, "to_configurable_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_binding_fault_ref_to_configurable_free);
    axis2_hash_set(binding_fault_ref_impl->methods, "super_objs", 
            AXIS2_HASH_KEY_STRING, axis2_woden_binding_fault_ref_super_objs);
    axis2_hash_set(binding_fault_ref_impl->methods, "type", 
            AXIS2_HASH_KEY_STRING, axis2_woden_binding_fault_ref_type);
...
AXIS2_DECLARE(axis2_woden_binding_fault_ref_t *)
axis2_woden_binding_fault_ref_create(axis2_env_t **env)
{
    axis2_woden_binding_fault_ref_impl_t *binding_fault_ref_impl = NULL;
    void *configurable = NULL;
    ...
    binding_fault_ref_impl->nested_configurable = axis2_woden_nested_configurable_create(env);
    ...
    axis2_hash_set(binding_fault_ref_impl->super, "AXIS2_WODEN_BINDING_FAULT_REF", 
            AXIS2_HASH_KEY_STRING, 
            &(binding_fault_ref_impl->binding_fault_ref));
    axis2_hash_set(binding_fault_ref_impl->super, "AXIS2_WODEN_NESTED_CONFIGURABLE", 
            AXIS2_HASH_KEY_STRING, 
            binding_fault_ref_impl->nested_configurable);
    configurable = AXIS2_WODEN_NESTED_CONFIGURABLE_GET_BASE_IMPL(
            binding_fault_ref_impl->nested_configurable, env);
    axis2_hash_set(binding_fault_ref_impl->super, "AXIS2_WODEN_CONFIGURABLE", 
...
axis2_status_t AXIS2_CALL
axis2_woden_binding_fault_ref_free(void *binding_fault_ref,
                        axis2_env_t **env)
{
    axis2_woden_binding_fault_ref_impl_t *binding_fault_ref_impl = NULL;
    ...
    {
        AXIS2_WODEN_DIRECTION_FREE(binding_fault_ref_impl->f_direction, env);
        binding_fault_ref_impl->f_direction = NULL;
    }

    if(binding_fault_ref_impl->f_msg_label)
    {
        AXIS2_WODEN_MSG_LABEL_FREE(binding_fault_ref_impl->
                f_msg_label, env);
        binding_fault_ref_impl->f_msg_label = NULL;
    }
    ...
    {
        AXIS2_WODEN_INTERFACE_FAULT_REF_FREE(binding_fault_ref_impl->
    ...
    {
        AXIS2_WODEN_NESTED_CONFIGURABLE_FREE(binding_fault_ref_impl->
...
axis2_woden_binding_fault_ref_resolve_methods(
        ...
        axis2_hash_t *methods)
{
    axis2_woden_binding_fault_ref_impl_t *binding_fault_ref_impl_l = NULL;
    ...
    binding_fault_ref->ops->free = axis2_hash_get(methods, "free", 
            AXIS2_HASH_KEY_STRING);
    binding_fault_ref->ops->to_binding_fault_ref_free = 
            axis2_hash_get(methods, "to_binding_fault_ref_free", 
            AXIS2_HASH_KEY_STRING);
        ...
        axis2_env_t **env)
{
    ...
    AXIS2_ENV_CHECK(env, NULL);
    super = AXIS2_WODEN_BINDING_FAULT_REF_SUPER_OBJS(binding_fault_ref, env);
    binding_fault_ref_impl = INTF_TO_IMPL(axis2_hash_get(super, 
                "AXIS2_WODEN_BINDING_FAULT_REF", AXIS2_HASH_KEY_STRING));
