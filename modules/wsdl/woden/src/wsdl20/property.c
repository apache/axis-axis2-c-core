...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_property_element_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_nested_element_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_documentable_element_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_documentable_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_wsdl_obj_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_nested_component_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_wsdl_component_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_attr_extensible_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
axis2_status_t AXIS2_CALL
axis2_woden_property_to_element_extensible_free(
        void *property,
        axis2_env_t **env)
{
    axis2_woden_property_impl_t *property_impl = NULL;
...
create(axis2_env_t **env)
{
    ...
    axis2_hash_set(property_impl->methods, "free", AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_free);
    axis2_hash_set(property_impl->methods, "to_property_element_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_property_element_free);
    axis2_hash_set(property_impl->methods, "to_nested_element_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_nested_element_free);
    axis2_hash_set(property_impl->methods, "to_documentable_element_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_documentable_element_free);
    axis2_hash_set(property_impl->methods, "to_documentable_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_documentable_free);
    axis2_hash_set(property_impl->methods, "to_wsdl_obj_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_wsdl_obj_free);
    axis2_hash_set(property_impl->methods, "to_nested_component_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_nested_component_free);
    axis2_hash_set(property_impl->methods, "to_wsdl_component_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_wsdl_component_free);
    axis2_hash_set(property_impl->methods, "to_attr_extensible_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_attr_extensible_free);
    axis2_hash_set(property_impl->methods, "to_element_extensible_free", 
            AXIS2_HASH_KEY_STRING, 
            axis2_woden_property_to_element_extensible_free);
        ...
        axis2_hash_t *methods)
{
    ...
    property->ops->free = axis2_hash_get(methods, "free", 
            AXIS2_HASH_KEY_STRING);
    property->ops->to_property_free = axis2_hash_get(methods, 
            "to_property_free", AXIS2_HASH_KEY_STRING);
