...
GUTHTHILA_DECLARE(guththila_xml_stream_writer_t*) guththila_create_xml_stream_writer(guththila_environment_t *environment,FILE* writer,guththila_char_t* encoding, int prefix_defaulting)
{
