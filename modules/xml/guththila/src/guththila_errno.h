 ...
 * Error Codes
 */
#define GUTHTHILA_STREAM_WRITER_ERROR_NOT_IN_GUTHTHILA_START_ELEMENT        (GUTHTHILA_START_ERROR + 1)
...
#define GUTHTHILA_STREAM_WRITER_ERROR_GUTHTHILA_COMMENT_NULL        (GUTHTHILA_START_ERROR + 10)
#define GUTHTHILA_STREAM_WRITER_ERROR_ILLEGAL_GUTHTHILA_COMMENT        (GUTHTHILA_START_ERROR + 11)
