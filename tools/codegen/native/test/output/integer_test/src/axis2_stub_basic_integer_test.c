        ...
        /**
        * output/integer_test/src/axis2_stub_basic_integer_test.c
        *
        * This file was auto-generated from WSDL for "basic_integer_test|http://localhost/axis/basic_integer_test" service
        * by the Apache Axis2/C Native version: 1.0.0  Built on : Nov 21, 2025 (11:49:28 HST)
        */

        #include "axis2_stub_basic_integer_test.h"

        /**
         * Default endpoint URI
         */
        static const axis2_char_t *default_endpoint_uri = "http://localhost/axis/basic_integer_test";

        /**
         * Create and return the stub
         */
        axis2_stub_t* AXIS2_CALL
        axis2_stub_create_basic_integer_test(const axutil_env_t *env,
                                        ...
                                        const axis2_char_t *endpoint_uri)
        {
            ...
            axis2_stub_populate_services_for_basic_integer_test(stub, env);
            return stub;
        }

        /**
         * Populate the services for basic_integer_test
         */
        void AXIS2_CALL
        axis2_stub_populate_services_for_basic_integer_test(axis2_stub_t *stub, const axutil_env_t *env)
        {
            ...
            /* Create service */
            svc = axis2_svc_create_with_qname(env, axutil_qname_create(env, "basic_integer_test", "http://localhost/axis/basic_integer_test", NULL));
            
            /* Add add operation */
            op_qname = axutil_qname_create(env, "add", "http://localhost/axis/basic_integer_test", NULL);
            op = axis2_op_create_with_qname(env, op_qname);
            axis2_op_set_msg_exchange_pattern(op, env, AXIS2_MEP_URI_IN_OUT);
            axis2_svc_add_op(svc, env, op);
            
            /* Add sub operation */
            op_qname = axutil_qname_create(env, "sub", "http://localhost/axis/basic_integer_test", NULL);
            op = axis2_op_create_with_qname(env, op_qname);
            axis2_op_set_msg_exchange_pattern(op, env, AXIS2_MEP_URI_IN_OUT);
            axis2_svc_add_op(svc, env, op);
            
            /* Add mul operation */
            op_qname = axutil_qname_create(env, "mul", "http://localhost/axis/basic_integer_test", NULL);
            op = axis2_op_create_with_qname(env, op_qname);
            axis2_op_set_msg_exchange_pattern(op, env, AXIS2_MEP_URI_IN_OUT);
            axis2_svc_add_op(svc, env, op);
            
            /* Add div operation */
            op_qname = axutil_qname_create(env, "div", "http://localhost/axis/basic_integer_test", NULL);
            op = axis2_op_create_with_qname(env, op_qname);
            axis2_op_set_msg_exchange_pattern(op, env, AXIS2_MEP_URI_IN_OUT);
            axis2_svc_add_op(svc, env, op);
        ...
        axis2_stub_get_endpoint_uri_of_basic_integer_test(const axutil_env_t *env)
        {
