        ...
        /**
        * output/boolean_test/src/axis2_stub_basic_boolean_test.h
        *
        ...
        */
        ...
        #ifndef AXIS2_STUB_BASIC_BOOLEAN_TEST_H
        #define AXIS2_STUB_BASIC_BOOLEAN_TEST_H
	...
	extern "C" {
        ...
        /**
         * axis2_stub_create_basic_boolean_test
        ...
        /**
         * axis2_stub_populate_services_for_basic_boolean_test
         * populate the svc in stub with the service and operation QNames
         * @param stub The stub
         * @param env environment ( mandatory)
         */
        void axis2_stub_populate_services_for_basic_boolean_test( axis2_stub_t *stub, const axutil_env_t *env);

        /**
         * axis2_stub_get_endpoint_uri_of_basic_boolean_test
	...
	#endif
	#endif /* AXIS2_STUB_BASIC_BOOLEAN_TEST_H */
