        ...
        /**
        * output/enumeration_test/src/axis2_stub_enumeration_test.h
        *
        ...
        */
        ...
        #ifndef AXIS2_STUB_ENUMERATION_TEST_H
        #define AXIS2_STUB_ENUMERATION_TEST_H
	...
	extern "C" {
        ...
        /**
         * axis2_stub_create_enumeration_test
        ...
        /**
         * axis2_stub_populate_services_for_enumeration_test
         * populate the svc in stub with the service and operation QNames
         * @param stub The stub
         * @param env environment ( mandatory)
         */
        void axis2_stub_populate_services_for_enumeration_test( axis2_stub_t *stub, const axutil_env_t *env);

        /**
         * axis2_stub_get_endpoint_uri_of_enumeration_test
	...
	#endif
	#endif /* AXIS2_STUB_ENUMERATION_TEST_H */
