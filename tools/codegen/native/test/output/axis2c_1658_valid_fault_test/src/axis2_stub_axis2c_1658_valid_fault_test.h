        ...
        /**
        * output/axis2c_1658_valid_fault_test/src/axis2_stub_axis2c_1658_valid_fault_test.h
        *
        ...
        */
        ...
        #ifndef AXIS2_STUB_AXIS2C_1658_VALID_FAULT_TEST_H
        #define AXIS2_STUB_AXIS2C_1658_VALID_FAULT_TEST_H
	...
	extern "C" {
        ...
        /**
         * axis2_stub_create_axis2c_1658_valid_fault_test
        ...
        /**
         * axis2_stub_populate_services_for_axis2c_1658_valid_fault_test
         * populate the svc in stub with the service and operation QNames
         * @param stub The stub
         * @param env environment ( mandatory)
         */
        void axis2_stub_populate_services_for_axis2c_1658_valid_fault_test( axis2_stub_t *stub, const axutil_env_t *env);

        /**
         * axis2_stub_get_endpoint_uri_of_axis2c_1658_valid_fault_test
	...
	#endif
	#endif /* AXIS2_STUB_AXIS2C_1658_VALID_FAULT_TEST_H */
