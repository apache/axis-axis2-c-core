    ...
    "\"properties\":{"
        ...
        "\"n_periods_per_year\":{\"type\":\"integer\",\"default\":1,"
            "\"description\":\"Periods per year of the INPUT matrix. Default 1 = the matrix is already "
                ...
                "Refused if the request also says covariance_basis \\\"annualized\\\"\"},"
...
static const char SCHEMA_COMPOSE_COVARIANCE[] =
    ...
    "\"properties\":{"
        "\"n_assets\":{\"type\":\"integer\","
            "\"description\":\"Number of assets (max 500: the check is O(n^3) and the reply is O(n^2)). "
                "Inferred from volatilities if omitted\"},"
...
static const char SCHEMA_SCENARIO_ANALYSIS[] =
    ...
    "\"properties\":{"
        "\"assets\":{"
            "\"type\":\"array\","
            "\"description\":\"Portfolio assets, each with its scenario list\","
            "\"items\":{"
                "\"type\":\"object\","
                "\"properties\":{"
                    ...
                    "\"scenarios\":{\"type\":\"array\",\"minItems\":2,"
                        "\"description\":\"One entry per scenario. Probabilities must sum to 1.0\","
                        "\"items\":{\"type\":\"object\","
                            "\"properties\":{"
                                "\"price\":{\"type\":\"number\","
                                    "\"description\":\"Target price in this scenario\"},"
                                "\"probability\":{\"type\":\"number\","
                                    "\"description\":\"Probability weight of this scenario\"}"
                            "},"
                            "\"required\":[\"price\",\"probability\"]"
                        "}}"
                "},"
                "\"required\":[\"asset_id\",\"current_price\",\"scenarios\"]"
            "}"
        "},"
