                        ...
                        axiom_xml_writer_t *xml_writer)
{
    ...
    om_output_impl->om_output.ops = (axiom_output_ops_t *)AXIS2_MALLOC(
                                        env->allocator,
                                        sizeof(axiom_output_ops_t));
    ...
    om_output_impl->om_output.ops->get_next_content_id = axiom_output_get_next_content_id;
