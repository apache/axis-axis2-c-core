...
AXIS2_DECLARE(axis2_options_t*) axis2_options_create(const axis2_env_t *env);

AXIS2_DECLARE(axis2_options_t*) axis2_options_create_with_parent(const axis2_env_t *env,
